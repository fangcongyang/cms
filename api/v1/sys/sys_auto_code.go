...
func PreviewTemp(c *gin.Context) {
	...
	autoCode, err := sys.PreviewTemp(a)
	if err != nil {
...
func CreateTemp(c *gin.Context) {
	...
	if a.AutoCreateApiToSql {
		if err := sys.AutoCreateApi(&a); err != nil {
...
func GetTables(c *gin.Context) {
	...
	err, tables := sys.GetTables(dbName)
	if err != nil {
...
func GetColumn(c *gin.Context) {
	...
	if err, columns := sys.GetColumn(tableName, dbName); err != nil {
		global.GVA_LOG.Error("获取失败!", zap.Any("err", err))
		response.FailWithMessage("获取失败", c)
	} else {
