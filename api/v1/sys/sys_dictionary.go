...
func CreateSysDictionary(c *gin.Context) {
	...
	if err := sys.CreateSysDictionary(dictionary); err != nil {
...
func DeleteSysDictionary(c *gin.Context) {
	var dictionary model.SysDictionary
	_ = c.ShouldBindJSON(&dictionary)
	if err := sys.DeleteSysDictionary(dictionary); err != nil {
...
func UpdateSysDictionary(c *gin.Context) {
	var dictionary model.SysDictionary
	_ = c.ShouldBindJSON(&dictionary)
	if err := sys.UpdateSysDictionary(&dictionary); err != nil {
...
func FindSysDictionary(c *gin.Context) {
	...
	if err, sysDictionary := sys.GetSysDictionary(dictionary.Type, dictionary.Id); err != nil {
...
func GetSysDictionaryList(c *gin.Context) {
	...
	if err, list, total := sys.GetSysDictionaryInfoList(pageInfo); err != nil {
