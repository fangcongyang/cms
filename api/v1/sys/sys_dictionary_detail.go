...
func CreateSysDictionaryDetail(c *gin.Context) {
	...
	if err := sys.CreateSysDictionaryDetail(detail); err != nil {
...
func DeleteSysDictionaryDetail(c *gin.Context) {
	var detail model.SysDictionaryDetail
	_ = c.ShouldBindJSON(&detail)
	if err := sys.DeleteSysDictionaryDetail(detail); err != nil {
...
func UpdateSysDictionaryDetail(c *gin.Context) {
	var detail model.SysDictionaryDetail
	_ = c.ShouldBindJSON(&detail)
	if err := sys.UpdateSysDictionaryDetail(&detail); err != nil {
...
func FindSysDictionaryDetail(c *gin.Context) {
	...
	if err, resysDictionaryDetail := sys.GetSysDictionaryDetail(detail.Id); err != nil {
...
func GetSysDictionaryDetailList(c *gin.Context) {
	...
	if err, list, total := sys.GetSysDictionaryDetailInfoList(pageInfo); err != nil {
