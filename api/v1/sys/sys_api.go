...
func CreateApi(c *gin.Context) {
	...
	if err := sys.CreateApi(api); err != nil {
...
func DeleteApi(c *gin.Context) {
	...
	if err := sys.DeleteApi(api); err != nil {
...
func GetApiList(c *gin.Context) {
	...
	if err, list, total := sys.GetAPIInfoList(pageInfo.SysApi, pageInfo.PageInfo, pageInfo.OrderKey, pageInfo.Desc); err != nil {
...
func GetApiById(c *gin.Context) {
	...
	err, api := sys.GetApiById(idInfo.Id)
	if err != nil {
		global.GVA_LOG.Error("获取失败!", zap.Any("err", err))
		response.FailWithMessage("获取失败", c)
	} else {
...
func UpdateApi(c *gin.Context) {
	...
	if err := sys.UpdateApi(api); err != nil {
...
func GetAllApis(c *gin.Context) {
	if err, apis := sys.GetAllApis(); err != nil {
		global.GVA_LOG.Error("获取失败!", zap.Any("err", err))
		response.FailWithMessage("获取失败", c)
	} else {
...
func DeleteApisByIds(c *gin.Context) {
	...
	if err := sys.DeleteApisByIds(ids); err != nil {
		global.GVA_LOG.Error("删除失败!", zap.Any("err", err))
		response.FailWithMessage("删除失败", c)
	} else {
		response.OkWithMessage("删除成功", c)
