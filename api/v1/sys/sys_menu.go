...
func GetMenu(c *gin.Context) {
	if err, menus := sys.GetMenuTree(GetUserRoleId(c)); err != nil {
...
func GetBaseMenuTree(c *gin.Context) {
	if err, menus := sys.GetBaseMenuTree(); err != nil {
		global.GVA_LOG.Error("获取失败!", zap.Any("err", err))
		response.FailWithMessage("获取失败", c)
	} else {
...
func GetMenuAuthority(c *gin.Context) {
	...
	if err, menus := sys.GetMenuAuthority(&param); err != nil {
		global.GVA_LOG.Error("获取失败!", zap.Any("err", err))
...
func AddBaseMenu(c *gin.Context) {
	...
	//	return
	//}
	if err := sys.AddBaseMenu(menu); err != nil {
		global.GVA_LOG.Error("添加失败!", zap.Any("err", err))
...
func GetMenuList(c *gin.Context) {
	...
	if err, menuList, total := sys.GetInfoList(); err != nil {
		global.GVA_LOG.Error("获取失败!", zap.Any("err", err))
		response.FailWithMessage("获取失败", c)
	} else {
