...
func CreateSysOperationRecord(c *gin.Context) {
	...
	if err := sys.CreateSysOperationRecord(sysOperationRecord); err != nil {
...
func DeleteSysOperationRecord(c *gin.Context) {
	var sysOperationRecord model.SysOperationRecord
	_ = c.ShouldBindJSON(&sysOperationRecord)
	if err := sys.DeleteSysOperationRecord(sysOperationRecord); err != nil {
...
func DeleteSysOperationRecordByIds(c *gin.Context) {
	...
	if err := sys.DeleteSysOperationRecordByIds(IDS); err != nil {
...
func FindSysOperationRecord(c *gin.Context) {
	...
	if err, resysOperationRecord := sys.GetSysOperationRecord(sysOperationRecord.Id); err != nil {
...
func GetSysOperationRecordList(c *gin.Context) {
	...
	if err, list, total := sys.GetSysOperationRecordInfoList(pageInfo); err != nil {
