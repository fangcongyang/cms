...
func UpdateCasbin(permission string, casbinInfos []request.CasbinInfo) error {
	ClearCasbin(0, permission)
	rules := [][]string{}
	for _, v := range casbinInfos {
		...
		rules = append(rules, []string{cm.Permission, cm.Path, cm.Method})
	}
	e := Casbin()
...
func Casbin() *casbin.Enforcer {
	...
	e.AddFunction("PermissionMatch", PermissionMatch)
...
func PermissionMatch(args ...interface{}) (interface{}, error) {
	...
	return strings.Contains(name1, name2), nil
}
